...
| 대형 로그 소크 | `be3c13b`, `85533d9` | 격리 Electron / 합성 UTF-8 / Windows 독점 잠금 | 2026-08-26 | 부분 통과 | 40→44MB 제한·trim·재시작, 10초/1,200 이벤트, Tail 파일 부재→복원, 잠긴 1/2 파일 부분 성공·해제 후 재수렴. 장시간·인코딩 조합 대기 |

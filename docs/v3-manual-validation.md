...
부분 계측 기록(2026-08-26, `8715215` 기반 격리 source Electron): 2560×1440 물리 모니터에서 `force-device-scale-factor` 1/1.25/1.5로 각각 별도 프로세스를 시작했다. renderer `devicePixelRatio`는 1/1.25/1.5와 일치했고 작업영역(DIP)은 2560×1392, 2048×1114, 1707×928이었다. 1420×860 기본 계수 계산기 창은 각각 1420×860, 1422×862, 1422×860으로 작업영역 안에 표시됐고 document scroll 크기가 client 크기와 같아 가로·세로 넘침이 없었다. 실제 Windows 배율 설정 전환과 게임 기준 오버레이 정렬, 1280×720·800×600 물리 작업영역은 수행하지 않았으므로 체크 항목은 대기로 둔다.
...
| DPI·모니터·RDP | `8715215` | 격리 source Electron / 강제 100·125·150% | 2026-08-26 06:18~06:19 KST | 부분 통과 | DPR 일치, 대형 계산기 창 작업영역 내 표시·overflow 없음. 실제 OS 배율 전환·게임 정렬·모니터/RDP 대기 |

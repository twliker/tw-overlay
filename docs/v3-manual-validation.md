...
| 종료·로그오프 | `93d2922`, `0884202`, `65ea23d`, `431c2a9` | 격리 source Electron / Windows `Alt+F4` / 별도 Electron 재시작·main finalizer·Drive timeout | 2026-08-26 06:15~06:49 KST | 부분 통과 | fresh 프로필 일반 종료 9ms, WAL 72/72, DB close·프로세스 종료 확인. 세 dirty 조합 재시작·main 종료와 응답 없는 Drive의 3초 취소·marker·WAL/DB 정리 확인. 실제 서버 반영 후 응답 유실·원격 재확인과 로그오프·시스템 종료 대기 |

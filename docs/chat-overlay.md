...
5. 스크롤하거나 창을 옮길 때는 사이드바·독의 마우스 아이콘 또는 기본 단축키 `Ctrl + Shift + T`로 마우스 투과를 끕니다.
6. 상단 이동 영역을 드래그해 원하는 위치로 옮긴 뒤, 게임을 조작할 때는 마우스 투과를 다시 켭니다.
...
- 스크롤바가 보여도 움직이지 않거나 채팅창을 옮길 수 없다면 투과를 끄고 조작하세요.

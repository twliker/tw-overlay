...
function buildTestHtml(): string {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    * { box-sizing: border-box; }
    body { margin: 0; }
    .calendar-grid { width: 960px; }
    .loot-badge { box-sizing: border-box; height: 18px; flex: 0 0 18px; }
  </style></head><body>
    <div id="calendar-grid" class="calendar-grid">
      <div id="overflow-cell" class="calendar-cell" data-calendar-day="2026-08-27">
      ...
      <div id="short-cell" class="calendar-cell" data-calendar-day="2026-08-28">
...
async function main(): Promise<void> {
  ...
  try {
    ...
    assert.equal(expanded.shortHeight, 120, '같은 행의 다른 날짜 카드까지 늘어났습니다.');
    ...
    assert.deepEqual(resized, { expanded: false, ariaExpanded: 'false', height: 120 },
